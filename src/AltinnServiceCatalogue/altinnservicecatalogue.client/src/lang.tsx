...
const translations: Record<string, Record<Lang, string>> = {
  'accessMap.title': { nb: "Tilgangskart", en: "Access map" },
  'accessMap.eyebrow': { nb: "Utforsk sammenhengene", en: "Explore the connections" },
  'accessMap.intro': { nb: "Se hvilke tilgangspakker en rolle gir. Velg en rolle og en kontekst for å følge koblingene.", en: "See which access packages a role grants. Choose a role and a context to follow the connections." },
  'accessMap.catalogue': { nb: "Dette er offentlige katalogdata, ikke dine personlige rettigheter. En pakke kan gis av flere roller.", en: "This is public catalogue data, not your personal permissions. A package can be granted by several roles." },
  'accessMap.grouping': { nb: "Områdene grupperer pakkene; de er ikke ekstra tilgangsvilkår. Klikk på rollen eller en pakke for å åpne detaljer.", en: "Areas group the packages; they are not additional access conditions. Click the role or a package to open details." },
  'accessMap.findRole': { nb: "Finn rolle", en: "Find role" },
  'accessMap.chooseRole': { nb: "Velg rolle", en: "Choose role" },
  'accessMap.context': { nb: "Kontekst", en: "Context" },
  'accessMap.person': { nb: "Person", en: "Person" },
  'accessMap.role': { nb: "Rolle", en: "Role" },
  'accessMap.area': { nb: "Område", en: "Area" },
  'accessMap.areas': { nb: "Områder og tilgangspakker", en: "Areas and access packages" },
  'accessMap.package': { nb: "Tilgangspakke", en: "Access package" },
  'accessMap.tree': { nb: "Rollens tilgangspakker", en: "Access packages granted by the role" },
  'accessMap.rootHint': { nb: "Følg grenene for å utforske pakkene i denne konteksten.", en: "Follow the branches to explore packages in this context." },
  'accessMap.ungrouped': { nb: "Uten område", en: "Without area" },
  'accessMap.loading': { nb: "Laster katalogdata …", en: "Loading catalogue data …" },
  'accessMap.retry': { nb: "Prøv igjen", en: "Try again" },
  'accessMap.error': { nb: "Kunne ikke hente katalogdata. Prøv igjen.", en: "Could not load catalogue data. Try again." },
  'accessMap.partial': { nb: "Oversikten er ufullstendig.", en: "This overview is incomplete." },
  'accessMap.contextError': { nb: "Kontekstlisten kunne ikke hentes. Andre kontekster er uavklart.", en: "The context catalogue could not be loaded. Other contexts remain unresolved." },
  'accessMap.packageError': { nb: "Pakkene kunne ikke bekreftes. Antall er ukjent.", en: "Packages could not be confirmed. The count is unknown." },
  'accessMap.roleGone': { nb: "Rollen finnes ikke i gjeldende miljø. Velg en annen rolle.", en: "The role does not exist in this environment. Choose another role." },
  'accessMap.variantGone': { nb: "Konteksten finnes ikke i gjeldende miljø. Person er valgt.", en: "The context does not exist in this environment. Person has been selected." },
  'accessMap.environmentChanged': { nb: "Miljøet er endret. Søk og åpne områder er nullstilt.", en: "The environment changed. Search and expanded areas have been reset." },
  'accessMap.roleMatches': { nb: "roller matcher søket", en: "roles match the search" },
  'accessMap.noRoles': { nb: "Ingen roller finnes i katalogen.", en: "No roles exist in the catalogue." },
  'accessMap.noRoleMatches': { nb: "Ingen roller matcher søket.", en: "No roles match the search." },
  'accessMap.start': { nb: "Velg en rolle for å se forbindelsene", en: "Choose a role to see its connections" },
  'accessMap.startHint': { nb: "Kartet viser én rolle om gangen, med pakkene samlet etter område.", en: "The map shows one role at a time, with packages grouped by area." },
  'accessMap.findPackage': { nb: "Finn pakke i kartet", en: "Find a package in the map" },
  'accessMap.clear': { nb: "Tøm søk", en: "Clear search" },
  'accessMap.provisional': { nb: "Foreløpig:", en: "Provisional:" },
  'accessMap.of': { nb: "treff av", en: "matches of" },
  'accessMap.packages': { nb: "pakker", en: "packages" },
  'accessMap.empty': { nb: "Ingen tilgangspakker i valgt kontekst", en: "No access packages in this context" },
  'accessMap.noMatches': { nb: "Ingen pakker matcher søket", en: "No packages match the search" },
  // Layout
